...
<body>
  ...
  <button id="generer-grille-button">Générer une nouvelle grille</button>

  <!-- Conteneur pour afficher la grille -->
  ...
  <script>
    ...
    genererGrilleButton.addEventListener('click', function() {
      ...
      grilleContainer.innerHTML = "Voici votre grille de loto : " + grille.join(", ");
    });
  </script>
</body>
</html>
